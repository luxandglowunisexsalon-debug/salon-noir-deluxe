...
export const Route = createFileRoute("/loyalty")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Earn points on every visit to Lux & Glow in Ashford and unlock member rewards.",
      },
      { property: "og:title", content: `The Glow Circle — ${SALON_CONFIG.name}` },
      {
        property: "og:description",
        content: "The Glow Circle loyalty rewards at our Ashford barber and unisex salon.",
      },
    ],
    ...
    <SiteShell>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 md:px-10 md:py-28">
        <div className="flex items-end justify-between">
          ...
          <Link
            to="/pricing"
            className="hidden text-[11px] tracking-[0.2em] uppercase text-charcoal hover:text-gold md:block"
          >
            See pricing →
          </Link>
        </div>
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-3">
          {membershipPlans.map((p) => {
            ...
            return (
              <article
                key={p.tier}
                className="relative bg-ivory border border-border p-9 transition hover:shadow-luxe"
              >
                ...
                <p className="mt-7 font-display text-4xl text-charcoal">
                  £{p.price}
                ...
                <Link
                  to="/booking"
                  className="mt-9 block rounded-full border border-charcoal py-3.5 text-center text-[12px] tracking-[0.2em] uppercase text-charcoal hover:bg-charcoal hover:text-ivory"
                >
                  Join {p.tier}
                </Link>
              </article>
      ...
      <section className="bg-cream/60 border-y border-border">
        <div className="mx-auto max-w-7xl px-5 py-20 md:px-10 md:py-24">
          ...
          <h2 className="mt-3 font-display text-3xl text-charcoal md:text-5xl">
            Quietly considered, never noisy.
          </h2>
            ...
            {[
              {
                n: "01",
                t: "Enrol in a minute",
                d: "Choose your tier online or with our concierge.",
              },
              { n: "02", t: "Visit", d: "Your barber and chair are remembered, every time." },
              {
                n: "03",
                t: "Earn quietly",
                d: "Points accrue automatically — no cards, no apps to chase.",
              },
              {
                n: "04",
                t: "Receive",
                d: "Perks appear in your members' diary. Use them, or don't.",
              },
            ].map((s) => (
          ...
          {[
            {
              ...
              a: "Yes — pause for up to three months a year, with a single message to your concierge.",
            },
            {
              q: "Are unused services rolled over?",
              a: "Silver and Gold members may roll one unused service into the following month.",
            },
            {
              q: "Can I gift a membership?",
              a: "Beautifully. We deliver a hand-pressed envelope and a private welcome appointment.",
            },
            {
              q: "Is there a joining fee?",
              a: "There is no joining fee. Membership is monthly, cancel anytime.",
            },
          ].map((f) => (
