# Roadmap — real booking system

- [x] Booking SQL migration (guest bookings, hours, closures, schedules, double-booking lock, starter data)
- [x] Booking server functions (services, stylists, availability, create/cancel)
- [x] Rewrite /booking page to use live data
